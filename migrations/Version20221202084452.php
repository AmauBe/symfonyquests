 ...
 */
final class Version20221202084452 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE season ADD program_id INT DEFAULT NULL, DROP program_id_id');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE season ADD program_id_id INT NOT NULL, DROP program_id');
